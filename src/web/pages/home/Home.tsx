                  ...
                  <div className={styles.cardsRow}>
                    <div className={styles.card}>
                      ...
                      <p className={styles.cardContent}>
                        ...
                        receive a written financial plan with recommendations and a financial consultation. Our plans are completely portable, and can be implemented either by you or any advisor of your choosing. Depending on the
                        complexity, our financial plans range in cost from $500 to $3,500
                      </p>
                    </div>
                    <div className={styles.card}>
                      ...
                      <div className={styles.cardRow}>
                        <div className={styles.cardColumn}>
                          ...
                          <p className={styles.cardSubContent}>
                            ...
                            managers (other independent investment advisors). Equity Portfolios use various Exchange Traded Fund (ETF) strategies to build broadly diversified portfolios which are monitored and rebalanced on an ongoing
                            basis. Income Accounts are custom designed to meet a client's unique income needs. JBA teams up with Advisors Asset Management and other investment advisors to acquire and manage income producing investments.
                            Income accounts are monitored on an ongoing basis. Cash management services such as checking, electronic transfers and bill paying are offered in conjunction with Shareholders Services Group and Pershing LLC. JBA
                            Money Management Services fee is .50% of assets under management. This fee is incorporated in the above Comprehensive Planning Fee Schedule. JBA Portfolios are offered exclusively to Comprehensive Financial
              ...
              <div className={styles.mainWrapper}>
                ...
                <div className={`${styles.cardsRow} ${styles.whyChooseUsRow}`}>
                  <div className={styles.card}>
                    ...
                    <p className={styles.cardContent}>
                      OUR CLIENTS COME FIRST! No faceless committees overriding what is in the client's best interest. JBA offers clients a fiduciary-based relationship, as opposed to the transactional-based, suitability relationship
                      offered by many registered representatives of banks, insurance companies, and brokerage firms.
                    </p>
                  </div>
                  <div className={styles.card}>
                  ...
                  <div className={styles.card}>
                    ...
                    <p className={styles.cardContent}>
                      <span>Flexibility of Relationship</span> – Clients can choose Ongoing Comprehensive Financial Planning Service or engage JBA for the stand alone services of Money Management, Financial Consulting, or a Written
                      Financial Plan.{" "}
                    </p>
                    <p className={styles.cardContent}>
                      <span>Pricing</span> – Stand-alone services are priced to be competitive in today's market place. We apply a fee offset for advisory fees received from the Matson Money, Morningstar Investment Services and Advisors
                      Asset Management investment programs to our minimum quarterly planning fee. At the minimum investment level, our comprehensive planning fee is only 1/4% higher than the average mutual fund expense ratio. At investment
                      levels of $800,000 or greater, our comprehensive financial planning service is the best value in the Baltimore-Washington Metropolitan Area.
                    </p>
                  </div>
                  <div className={styles.card}>
                    <h5 className={styles.cardTitle}>Tech"know"logy</h5>
                    <p className={styles.cardContent}>
                      Clients have access to MoneyGuidePro's goal oriented financial planning software 24/7. Cash Edge Software populates financial plans with live account data from all client accounts no matter where those accounts are
                      held. This functionality provides JBA clients with an up-to-date holistic view of their financial situation. JBA Financial works with Net2Sky, LLC, to ensure safety and security in both its local computer networks and
